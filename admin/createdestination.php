        ...
        <div class="ml-64 p-6 w-full">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form method="post" enctype="multipart/form-data">
                    <!-- Activity Name -->
                    <div class="mt-8">
                        <label for="act_name" class="block text-sm font-medium text-gray-700 mb-1">Destination
                            Name</label>
                    ...
                    <div class="mb-4">
                        <label for="act_desc" class="block text-sm font-medium text-gray-700 mb-1">Destination
                            Description</label>
                    ...
                    <!-- Activity Image -->
                    <div class="mb-4">
                        <label for="act_image" class="block text-sm font-medium text-gray-700 mb-1">Destination
                            Image</label>
